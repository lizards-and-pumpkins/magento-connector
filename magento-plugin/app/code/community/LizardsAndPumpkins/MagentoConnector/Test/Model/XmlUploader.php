...
class LizardsAndPumpkins_MagentoConnector_Test_Model_XmlUploader extends PHPUnit_Framework_TestCase
{
    ...
    public function testAllowProtocols($protocol)
    {
        ...
        $uploader = new LizardsAndPumpkins_MagentoConnector_Model_XmlUploader($string, $target);
    ...
    public function testDisallowedProtocols($protocol)
    {
        ...
        $target = $protocol . 'some/path';
        new LizardsAndPumpkins_MagentoConnector_Model_XmlUploader($string, $target);
    }
